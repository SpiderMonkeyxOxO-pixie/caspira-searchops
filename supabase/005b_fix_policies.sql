...
begin
  ...
  insert into public.jarvis_tasks (org_id, title, assignee, priority, done, section) values
    (p_org_id, 'Fix LCP 5.8s on UPI payment landing pages',                    'Arjun Sharma', 'critical', false, 'Technical'),
    (p_org_id, 'Publish pillar: "Best Online Casino India 2026"',              'Priya Nair',   'high',     false, 'Content'),
    (p_org_id, 'Disavow 340 Indonesian slot PBN backlinks',                    'Budi Santoso', 'high',     true,  'Authority'),
    (p_org_id, 'Add responsible gambling disclaimer in Hindi & Bahasa',        'You',          'medium',   false, 'Technical'),
    (p_org_id, 'Build 5 niche edits from Indian gaming authority publications', 'Jordan',       'low',      false, 'Authority');
