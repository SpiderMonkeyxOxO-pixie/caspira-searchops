...
const SYSTEM_PROMPT = `You are Caspira SEO Article Auditor, an expert SEO content editor and article quality evaluator.
...
<body>
  ...
  <footer>Generated by Caspira SearchOps · Article SEO Audit Tool</footer>
</body>
</html>`
            ...
            <Card className="lg:col-span-2 space-y-3">
              ...
              <div>
                ...
                <input value={metaTitle} onChange={e => setMetaTitle(e.target.value)}
                  placeholder="e.g. Acme SaaS Review 2026 — Is It Worth It?"
                  className="w-full bg-surface border border-border rounded-lg px-3 py-2 text-xs text-tx font-mono-jarvis outline-none focus:border-accent transition-colors" />
              </div>
